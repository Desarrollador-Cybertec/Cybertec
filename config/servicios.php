...
$servicios = [
    [
        ...
        "puntos" => [
            ...
            "Detección de intrusos (IDS/IPS) con IA.",
            "Defensa perimetral y segmentación Zero Trust.",
            "Auditoría continua ISO 27000."
        ]
    ],
    [
        ...
        "puntos" => [
            "Cámaras IP con Analítica de Video.",
            "Control de Acceso Biométrico.",
            "Integración Móvil Total."
        ]
    ],
    [
        ...
        "puntos" => [
            "Clusters de Servidores de Alta Disponibilidad.",
    ...
    [
        ...
        "puntos" => [
            "Mesa de Ayuda (Helpdesk) 24/7 con SLA garantizado.",
            "Renting Tecnológico: Equipos siempre actualizados.",
            "Gestión de activos y mantenimiento preventivo automatizado."
        ]
    ]
];
