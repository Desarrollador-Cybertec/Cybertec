...
<header id="inicio" class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-6" data-aos="zoom-in" data-aos-delay="450">
            <a href="#servicios" class="group relative px-8 py-4 rounded-xl bg-[rgb(27,146,208)] text-slate-900 font-bold overflow-hidden transition-all hover:scale-105">
            ...
            <a href="#contacto" class="px-8 py-4 rounded-xl bg-slate-900 border border-slate-700 text-white font-bold hover:bg-slate-800 hover:border-[rgb(27,146,208)]/50 transition-all">
                Agendar Consultoría
            </a>
        </div>
    </div>
