...
<!-- Hero -->
<header id="inicio" class="relative min-h-[80vh] flex items-center justify-center pt-14 pb-6 overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10 text-center flex flex-col items-center">
        ...
        <!-- Logo -->
        <div class="relative w-full max-w-xs md:max-w-md lg:max-w-lg mb-4" data-aos="fade-up">
        ...
        <!-- Headline -->
        <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-display font-bold text-white max-w-3xl mx-auto mb-2 sm:mb-3 leading-tight" data-aos="fade-up" data-aos-delay="100">
            Un ataque informático puede detener tu empresa <span class="text-red-400">en menos de 10 minutos.</span>
        </h1>

        <!-- Subheadline -->
        <p class="text-xs sm:text-sm md:text-base text-slate-400 max-w-xl mx-auto mb-2 font-light leading-relaxed" data-aos="fade-up" data-aos-delay="200">
            Cada día cientos de empresas pierden información, dinero y operaciones por no proteger su infraestructura tecnológica.
        </p>
        <p class="text-xs sm:text-sm md:text-base text-[rgb(27,146,208)] font-semibold max-w-xl mx-auto mb-4 sm:mb-5" data-aos="fade-up" data-aos-delay="250">
            Cybertec protege tu empresa antes de que ocurra.
        </p>

        <!-- CTAs -->
        <div class="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3 w-full sm:w-auto px-2 sm:px-0 mb-4" data-aos="zoom-in" data-aos-delay="300">
        ...
        <!-- Stat de impacto -->
        <div class="bg-slate-900/60 border border-red-500/20 rounded-xl px-4 py-2 mb-4 max-w-lg" data-aos="fade-up" data-aos-delay="350">
