...
<section class="py-24 bg-[#0B1120] relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div class="relative bg-slate-900/50 rounded-3xl border border-white/5 p-8 flex flex-col justify-center min-h-[500px] overflow-hidden group" data-aos="fade-right">
                <!-- Decor image -->
